export const transferProfiles={
 ...
 async:{title:'VocaScript 處理流程',system:['Audio','Transcription','Diarization','Summary / Export'],assumptions:['部分步驟耗時','中間結果可以被識別'],prompt:'改變工作流入與處理方式，觀察完成時間和等待狀態，再判斷哪些中間產物值得保存。'},
 failure:{title:'自動發文',system:['Browser Automation','Publish Action','Platform','Published Post'],assumptions:['點擊後可能 timeout','平台重複操作語意未知'],prompt:'不要假設重按安全。調整情境，觀察哪些結果仍未知、哪些效果可能重複。'},
