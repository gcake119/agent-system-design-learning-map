import test from 'node:test';import assert from 'node:assert/strict';import {units,unitById,stageById} from '../learning/v2/course.mjs';import {parseV2Route,v2Route,choose} from '../learning/v2/interaction.mjs';
